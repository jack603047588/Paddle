...
if(NOT XPU_TOOLCHAIN)
  ...
  # set(XPU_TOOLCHAIN ${PROJECT_BINARY_DIR}/third_party/xpu/src/extern_xpu/output_bp/xtdk-centos7_x86_64_gcc8u3)
  set(XPU_TOOLCHAIN ${PROJECT_BINARY_DIR}/third_party/xpu/src/extern_xpu/output/xtdk-llvm15-bdcentos_x86_64)
...
macro(compile_kernel COMPILE_ARGS)
  ...
  add_custom_command(
    ...
    COMMAND
      ...
      -fno-builtin --xpu-arch=xpu3 -fPIC ${XPU_CXX_DEFINES} ${XPU_CXX_FLAGS}
      ${XPU_CXX_INCLUDES} -I. -o kernel_build/${kernel_name}.bin.o.sec
      kernel_build/${kernel_name}.xpu --xpu-device-only -c -v
    COMMAND ${XTDK_DIR}/bin/xpu3-elfconv kernel_build/${kernel_name}.bin.o.sec
